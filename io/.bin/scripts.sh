...
DEFAULT_BUILD_COMMAND="bun build --entrypoints src/main.ts --outdir dist --target node --env inline --external pins --external timer --external wifi --external net --external bleserver --external btutils --external mqtt"
